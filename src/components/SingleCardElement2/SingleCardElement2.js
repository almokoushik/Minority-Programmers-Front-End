...
const SingleCardElement2 = (props) => {
    const history = useHistory()
    const handleClick = () => {
        history.push(`/startup/${props.props.id}`)
    }
    return (
        <div className="col col-md-3 col-sm-12 my-1">
            <div className="bg bg-white text-dark  text-start" style={{ borderRadius: "7px" }}>
...
export default SingleCardElement2;